  ...
  return (
    <div ref={rootRef} className="hs-popover-root relative shrink-0">
      <motion.button
        ...
        tabIndex={0}                     // Explicitly declare to match server and client
        suppressHydrationWarning         // Safe fallback for Framer Motion variance
      >
              ...
              {quickLanguages.map((code) => {
                ...
                return (
                  <motion.button
                    ...
                    tabIndex={0}                 // Synchronizes the interactive elements
                    suppressHydrationWarning     // Prevents framework hydration alerts
                  >
