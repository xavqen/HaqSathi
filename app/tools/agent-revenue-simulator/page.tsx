...
export const metadata = { title: 'Agent Revenue Simulator', description: 'Cyber cafe, local agents and service partners can estimate client revenue, break-even and package pricing.' }
