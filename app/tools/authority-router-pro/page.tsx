...
export const metadata = { title: 'Authority Router Pro | HaqSathi AI', description: 'Issue ke liye correct support, grievance, authority and escalation route choose karo.' }
