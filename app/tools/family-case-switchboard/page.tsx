...
export const metadata = { title: 'Family Case Switchboard | HaqSathi AI', description: 'Family/agent cases ko owner, priority, role plan aur reminder text ke saath organize karo.' }
