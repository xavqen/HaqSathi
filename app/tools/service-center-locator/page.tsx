...
export const metadata = { title: 'Service Center Route Planner | HaqSathi AI', description: 'City/state ke hisaab se online/offline authority route, questions aur visit checklist banao.' }
