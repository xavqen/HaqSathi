...
export const metadata = { title: 'Evidence Timeline Builder', description: 'Convert messy events into clean timeline, proof index, missing evidence and next best action.' }
