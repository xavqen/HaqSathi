...
export const metadata = { title: 'Privacy Redactor', description: 'Remove phone, email, UPI ID, account details and risky allegations before sharing complaint drafts publicly.' }
