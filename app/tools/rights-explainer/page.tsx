...
export const metadata = { title: 'Rights Explainer', description: 'Common people ke liye practical rights, what to ask, next steps and safe words in simple language.' }
