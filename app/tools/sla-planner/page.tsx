...
export const metadata: Metadata = { title: 'Complaint SLA Planner | HaqSathi AI', description: 'Generate safe follow-up timeline for refund, bank, UPI and cyber complaint cases.' }
