...
export const metadata = { title: 'Refund Negotiation Builder', description: 'Refund delay ke liye message ladder, proof order, firm wording and escalation schedule generate karo.' }
