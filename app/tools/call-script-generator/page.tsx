...
export const metadata = { title: 'Call Script Generator | HaqSathi AI', description: 'Bank, company support, helpline ya authority ko call karne ke liye safe Hinglish call script generate karo.' }
