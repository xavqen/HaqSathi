...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes = ['', '/complaint', '/refund', '/upi-help', '/cyber-fraud', '/bank-complaint', '/scheme-finder', '/documents', '/chat', '/templates', '/tools', '/tools/deadline-calculator', '/tools/complaint-strength-checker', '/tools/evidence-checklist', '/tools/risk-assessment', '/tools/application-tracker', '/tools/legal-notice-draft', '/tools/rti-helper', '/tools/consumer-forum-pack', '/tools/bank-escalation', '/tools/ombudsman-planner', '/tools/call-script-generator', '/tools/sla-planner', '/tools/grievance-route-finder', '/tools/fee-refund-calculator', '/tools/appeal-draft', '/authority-directory', '/state-guides', '/success-stories', '/filing-guides', '/emergency', '/resources', '/official-sources', '/partners', '/knowledge-base', '/tools/notice-reply-draft', '/tools/status-message-builder', '/tools/document-gap-analyzer', '/search', '/pricing', '/blog', '/contact', '/about', '/privacy', '/terms', '/disclaimer', '/final-launch-checklist', '/offline']
