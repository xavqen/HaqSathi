...
export async function generateMetadata({ params }: { params: Promise<{ state: string; slug: string }> }): Promise<Metadata> {
  ...
  return { title: `${scheme.title} Eligibility & Documents`, description: `${scheme.title} eligibility, documents and apply steps in simple language.` }
}
