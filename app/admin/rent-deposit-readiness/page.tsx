import { AlertTriangle, CheckCircle2, ClipboardList, Home, ShieldCheck, TerminalSquare } from 'lucide-react'
import { AdminShell } from '@/components/admin/admin-shell'
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card'
import { getRentDepositReadinessReport } from '@/lib/productivity/rent-deposit-readiness'

export const metadata = { title: 'Rent Deposit Readiness | Admin' }
...
export default function RentDepositReadinessPage() {
  const report = getRentDepositReadinessReport()
      ...
      <div className="space-y-6">
        <div className="rounded-[2rem] border border-emerald-100 bg-white p-6 shadow-soft sm:p-8">
          <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
            <div>
              <div className="flex items-center gap-2 text-sm font-black text-emerald-800"><Home className="h-5 w-5" /> Phase 97</div>
              <h1 className="mt-3 text-3xl font-black tracking-tight text-slate-950 sm:text-5xl">Rent deposit readiness</h1>
              <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-600 sm:text-base">Review tenant/landlord dispute copy, guidance-only disclaimer, address privacy warnings and mobile QA before launch.</p>
            </div>
        ...
        <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Review legal-safety wording, privacy redaction, proof pack and mobile UX.</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <div className="grid gap-6">
            <Card>
              ...
              <CardContent>
                <div className="rounded-2xl bg-slate-950 p-4 font-mono text-xs font-bold leading-6 text-emerald-100">
                  npm run rent-deposit:readiness<br />
                  /api/admin/rent-deposit-readiness<br />
                  /tools/rent-deposit-dispute-planner
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Rules for rent, deposit, notice and landlord/broker dispute workflows.</CardDescription>
              </CardHeader>
              <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardTitle>Rent dispute lanes</CardTitle>
            <CardDescription>Priority lanes and safety rules for the rent deposit dispute planner.</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
              {report.rentDepositReadinessLanes.map((lane) => (
