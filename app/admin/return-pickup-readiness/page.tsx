import { AlertTriangle, CheckCircle2, ClipboardList, PackageCheck, ShieldCheck, TerminalSquare } from 'lucide-react'
import { AdminShell } from '@/components/admin/admin-shell'
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card'
import { getReturnPickupReadinessReport } from '@/lib/productivity/return-pickup-readiness'

export const metadata = { title: 'Return Pickup Readiness | Admin' }
...
export default function ReturnPickupReadinessPage() {
  const report = getReturnPickupReadinessReport()
  return (
    <AdminShell>
      <div className="grid gap-6">
        <div className="rounded-[2rem] border border-emerald-100 bg-white p-6 shadow-soft sm:p-8">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div>
              <div className="flex items-center gap-2 text-sm font-black text-emerald-800"><PackageCheck className="h-5 w-5" /> Phase 95</div>
              <h1 className="mt-3 text-3xl font-black tracking-tight text-slate-950 sm:text-5xl">Return pickup readiness</h1>
              <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-600 sm:text-base">Review shopping return/refund copy, pickup proof, refund scam safety and mobile usability before public launch.</p>
            </div>
        ...
        <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Review return deadline estimates, proof checklist, scam safety and mobile QA.</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <div className="grid gap-6">
            <Card>
              ...
              <CardContent>
                <div className="rounded-2xl bg-slate-950 p-4 font-mono text-xs font-bold leading-6 text-emerald-100">
                  npm run return-pickup:readiness<br />
                  /api/admin/return-pickup-readiness<br />
                  /tools/return-pickup-planner
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Rules for return/refund and pickup workflows.</CardDescription>
              </CardHeader>
              <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardTitle>Return lanes</CardTitle>
            <CardDescription>Priority lanes and safety rules for the return pickup planner.</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
              {report.returnPickupReadinessLanes.map((lane) => (
