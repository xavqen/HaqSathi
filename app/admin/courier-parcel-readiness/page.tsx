...
export default function CourierParcelReadinessPage() {
  const report = getCourierParcelReadinessReport()
      ...
      <div className="space-y-6">
        <div className="rounded-[2rem] border border-emerald-100 bg-white p-6 shadow-soft">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div>
              <div className="flex items-center gap-2 text-sm font-black text-emerald-800"><Boxes className="h-5 w-5" /> Phase 105</div>
              <h1 className="mt-2 text-3xl font-black tracking-tight text-slate-950">Courier parcel planner readiness</h1>
              <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-600">Readiness controls for lost parcel, marked delivered, damaged/wrong item, pickup stuck, COD/payment and fake courier scam complaint planning.</p>
            </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>API: /api/admin/courier-parcel-readiness · Evidence: npm run courier-parcel:readiness</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Review before enabling this public courier/parcel workflow at scale.</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid gap-3 md:grid-cols-2">
              {report.courierParcelReadinessLanes.map((lane) => (
