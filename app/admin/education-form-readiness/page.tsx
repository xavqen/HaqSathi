import { AlertTriangle, CheckCircle2, ClipboardList, GraduationCap, ShieldCheck, TerminalSquare } from 'lucide-react'
import { AdminShell } from '@/components/admin/admin-shell'
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card'
import { getEducationFormReadinessReport } from '@/lib/productivity/education-form-readiness'

export const metadata = { title: 'Education Form Readiness | Admin' }
...
export default function EducationFormReadinessPage() {
  const report = getEducationFormReadinessReport()
      ...
      <div className="space-y-6">
        <div className="rounded-[2rem] border border-emerald-100 bg-white p-6 shadow-soft sm:p-8">
          <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
            <div>
              <div className="flex items-center gap-2 text-sm font-black text-emerald-800"><GraduationCap className="h-5 w-5" /> Phase 101</div>
              <h1 className="mt-3 text-3xl font-black tracking-tight text-slate-950 sm:text-5xl">Education form correction readiness</h1>
              <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-600 sm:text-base">Review student form correction copy, official-route warnings, privacy redaction, deadline wording and mobile QA before public promotion.</p>
            </div>
        ...
        <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Review correction copy, official route, privacy warnings and mobile UX.</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <div className="grid gap-6">
            <Card>
              ...
              <CardContent>
                <div className="rounded-2xl bg-slate-950 p-4 font-mono text-xs font-bold leading-6 text-emerald-100">
                  npm run education-form:readiness<br />
                  /api/admin/education-form-readiness<br />
                  /tools/education-form-correction-planner
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Rules for student form correction guidance.</CardDescription>
              </CardHeader>
              <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardTitle>Education form readiness lanes</CardTitle>
            <CardDescription>Priority lanes and review rules for correction planner.</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
              {report.educationFormReadinessLanes.map((lane) => (
