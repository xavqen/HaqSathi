import { AlertTriangle, CheckCircle2, ClipboardList, PhoneCall, ShieldCheck, TerminalSquare } from 'lucide-react'
import { AdminShell } from '@/components/admin/admin-shell'
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card'
import { getLoanAppReadinessReport } from '@/lib/productivity/loan-app-readiness'

export const metadata = { title: 'Loan App Readiness | Admin' }
...
export default function LoanAppReadinessPage() {
  const report = getLoanAppReadinessReport()
      ...
      <div className="space-y-6">
        <div className="rounded-[2rem] border border-emerald-100 bg-white p-6 shadow-soft sm:p-8">
          <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
            <div>
              <div className="flex items-center gap-2 text-sm font-black text-emerald-800"><PhoneCall className="h-5 w-5" /> Phase 99</div>
              <h1 className="mt-3 text-3xl font-black tracking-tight text-slate-950 sm:text-5xl">Loan app harassment readiness</h1>
              <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-600 sm:text-base">Review threat safety, harassment response copy, official-channel guidance, redaction warnings and mobile QA before public promotion.</p>
            </div>
        ...
        <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Review threat safety, secret redaction, proof list and mobile UX.</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <div className="grid gap-6">
            <Card>
              ...
              <CardContent>
                <div className="rounded-2xl bg-slate-950 p-4 font-mono text-xs font-bold leading-6 text-emerald-100">
                  npm run loan-app:readiness<br />
                  /api/admin/loan-app-readiness<br />
                  /tools/loan-app-harassment-planner
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Rules for loan app harassment guidance.</CardDescription>
              </CardHeader>
              <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardTitle>Loan app readiness lanes</CardTitle>
            <CardDescription>Priority lanes and review rules for the harassment planner.</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
              {report.loanAppReadinessLanes.map((lane) => (
