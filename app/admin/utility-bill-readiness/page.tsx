import { AlertTriangle, CheckCircle2, ClipboardList, Gauge, ShieldCheck, TerminalSquare } from 'lucide-react'
...
export const metadata = { title: 'Utility Bill Readiness | Admin' }
...
export default function UtilityBillReadinessPage() {
  const report = getUtilityBillDisputeReadinessReport()
  return (
    <AdminShell>
      <div className="grid gap-6">
        <div className="rounded-[2rem] border border-emerald-100 bg-white p-6 shadow-soft sm:p-8">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div>
              <div className="flex items-center gap-2 text-sm font-black text-emerald-800"><Gauge className="h-5 w-5" /> Phase 96</div>
              <h1 className="mt-3 text-3xl font-black tracking-tight text-slate-950 sm:text-5xl">Utility bill readiness</h1>
              <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-600 sm:text-base">Review utility bill dispute copy, proof checklist, secret-data warnings and official provider route before public launch.</p>
            </div>
        ...
        <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Review overcharge copy, meter/payment proof, official routes and mobile QA.</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <div className="grid gap-6">
            <Card>
              ...
              <CardContent>
                <div className="rounded-2xl bg-slate-950 p-4 font-mono text-xs font-bold leading-6 text-emerald-100">
                  npm run utility-bill:readiness<br />
                  /api/admin/utility-bill-readiness<br />
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Rules for bill correction, refund and disconnection-risk workflows.</CardDescription>
              </CardHeader>
              <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardTitle>Bill dispute lanes</CardTitle>
            <CardDescription>Priority lanes and safety rules for the utility bill dispute planner.</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
              {report.utilityBillReadinessLanes.map((lane) => (
