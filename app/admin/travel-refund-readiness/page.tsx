import { AlertTriangle, CheckCircle2, ClipboardList, Plane, ShieldCheck, TerminalSquare } from 'lucide-react'
import { AdminShell } from '@/components/admin/admin-shell'
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card'
import { getTravelRefundReadinessReport } from '@/lib/productivity/travel-refund-readiness'

export const metadata = { title: 'Travel Refund Readiness | Admin' }
...
export default function TravelRefundReadinessPage() {
  const report = getTravelRefundReadinessReport()
      ...
      <div className="space-y-6">
        <div className="rounded-[2rem] border border-emerald-100 bg-white p-6 shadow-soft sm:p-8">
          <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
            <div>
              <div className="flex items-center gap-2 text-sm font-black text-emerald-800"><Plane className="h-5 w-5" /> Phase 102</div>
              <h1 className="mt-3 text-3xl font-black tracking-tight text-slate-950 sm:text-5xl">Travel refund planner readiness</h1>
              <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-600 sm:text-base">Review travel refund copy, provider-policy wording, payment secret safety, travel document privacy and mobile QA before public promotion.</p>
            </div>
        ...
        <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Review refund copy, provider policy, payment safety and mobile UX.</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <div className="grid gap-6">
            <Card>
              ...
              <CardContent>
                <div className="rounded-2xl bg-slate-950 p-4 font-mono text-xs font-bold leading-6 text-emerald-100">
                  npm run travel-refund:readiness<br />
                  /api/admin/travel-refund-readiness<br />
                  /tools/travel-refund-cancellation-planner
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Rules for travel refund guidance.</CardDescription>
              </CardHeader>
              <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardTitle>Travel refund readiness lanes</CardTitle>
            <CardDescription>Priority lanes and review rules for refund/cancellation planner.</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
              {report.travelRefundReadinessLanes.map((lane) => (
