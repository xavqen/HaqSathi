  ...
  return (
    <main className="bg-slate-50">
      <section className="mx-auto max-w-5xl px-4 py-12">
        ...
        <div className="mt-8 rounded-3xl border bg-white p-6 shadow-soft"><h2 className="text-xl font-bold">Manual QA before public launch</h2><ol className="mt-4 list-decimal space-y-2 pl-5 text-sm text-slate-700"><li>Register/login/logout test karo.</li><li>Complaint, UPI, scheme, document generators test karo.</li><li>Document upload/download signed link test karo.</li><li>Razorpay test mode checkout aur webhook verify karo.</li><li>Forgot password email receive karke reset test karo.</li><li>Mobile Chrome me homepage, dashboard, tools and payment test karo.</li></ol></div>
      </section>
    </main>
  )
}
